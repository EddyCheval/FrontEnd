...
{
    //Tirer des exemples Xamarin (Xamarin samples : https://github.com/nishanil/Xamarin.Forms-Samples/tree/master/Samples%20(1.3)/Samples/Samples/Behaviors)
   public class StarBehavior : Behavior<View>
    {
        ...
        public static readonly BindableProperty IsHalvedProperty =
            BindableProperty.Create("IsHalved",
                                    typeof(bool),
                                    typeof(StarBehavior),
                                    false,
                                    propertyChanged: OnIsStarredChanged);
        ...
        {
            set { SetValue(IsHalvedProperty, value); }
            get { return (bool)GetValue(IsHalvedProperty); }
        }
